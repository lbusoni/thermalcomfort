...
LOCATIONS: dict[str, LocationInfo] = {
    ...
    "Bivigliano": LocationInfo(43.8936, 11.3219, "Bivigliano"),
    "Monte Senario": LocationInfo(43.8957, 11.3332, "Monte Senario"),
    "Caldine": LocationInfo(43.8341, 11.3082, "Caldine"),
    "Olmo": LocationInfo(43.8635, 11.3403, "Olmo"),
    "Consuma": LocationInfo(43.7806, 11.5960, "Consuma"),
    "Borgo San Lorenzo": LocationInfo(43.9543, 11.3882, "Borgo San Lorenzo"),
    "Moscheta": LocationInfo(44.0745, 11.4241, "Moscheta"),
    ...
    "Edmonton": LocationInfo(53.5461, -113.4938, "Edmonton"),
    "Victoria": LocationInfo(48.4284, -123.3656, "Victoria"),
    "New York": LocationInfo(40.7128, -74.0060, "New York"),
    "Los Angeles": LocationInfo(34.0522, -118.2437, "Los Angeles"),
    "San Diego": LocationInfo(32.7157, -117.1611, "San Diego"),
    "San Francisco": LocationInfo(37.7749, -122.4194, "San Francisco"),
